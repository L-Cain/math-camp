...
\ \\For this method, in order to prove that $P \rightarrow Q$, there are two steps: 1. Assume P is true; 2. Show that Q logically follows, usually from the definition of P. \pause
...
\item Do we conclude that pasta causes weight gain or that our experiment was not well run? \pause
\end{itemize}
...
\begin{itemize}
\item rework through Pemberton \& Rau Ch. 5
