...
E[X] & = & \int_{0}^{1} \int_{0}^{1} x (x + y) dxdy \nonumber  \pause \\
 & = & \frac{7}{12} \nonumber   \\
E[Y] & = & \int_{0}^{1} \int_{0}^{1} y(x + y) dxdy \nonumber \pause \\
 & = & \frac{7}{12} \nonumber  
 \end{eqnarray}
...
\begin{itemize}
\item[-] Beta is a distribution on \alert{proportions}  \pause
\item[-] Beta is a special case of the \alert{Dirichlet} distribution  \pause
